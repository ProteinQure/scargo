...
class ScargoTranspiler(ast.NodeVisitor):
    ...
    @staticmethod
    def _get_script_locals(path_to_script: Path) -> Dict[str, Any]:
        """
    ...
    def transpile(self, path_to_script: Path) -> None:
        ...
        self.script_locals = ScargoTranspiler._get_script_locals(path_to_script)
        workflow_params = ScargoTranspiler.transpile_parameters(self.script_locals)
        ScargoTranspiler._write_params_to_yaml(path_to_script, workflow_params)
        ...
        with open(path_to_script, "r") as source:
            self.tree = ast.parse(source.read(), type_comments=True)
        self.visit(self.tree)  # traverse the tree

        # add entrypoint, which should have become defined by visit_FunctionDef
    ...
    @staticmethod
    def _write_workflow_to_yaml(path_to_script: Path, transpiled_workflow: Dict[str, Any]) -> None:
        """
    ...
    @staticmethod
    def _write_params_to_yaml(path_to_script: Path, parameters: WorkflowParams) -> None:
        """
